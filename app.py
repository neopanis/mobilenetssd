...
lineaccesstoken = 'SUX1yDB4IyY0AeFMT05SKd5JZ6KhvIWc6zv7axkNSNunV1T+MMyKZ2cGBnEdYMaLMbkTqIAikyvYwS2uFupMS7kBWLmxuBIg9V4z3FgZO9h6A1OVa29nPKvDP1gTYag7dQbpUnL7qIhKj7jLznlXdQdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if (msg == "สวัสดี") :
          ...
          replyObj = TextSendMessage(text="สภาพ โสดจ้า")
          line_bot_api.reply_message(rtoken, replyObj)
        else :
          headers = request.headers
          json_headers = ({k:v for k, v in headers.items()})
          json_headers.update({'Host':'bots.dialogflow.com'})
          url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/df11f2ad-a62f-48a5-80ce-b7533039c8bd"
